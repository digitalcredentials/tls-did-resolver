...
var Resolver = /** @class */ (function () {
    ...
    Resolver.prototype.configureRegistry = function (registryAddress) {
        var registry = new ethers_1.ethers.Contract(REGISTRY, TLSDIDRegistry_json_1.default.abi, this.provider);
    ...
    Resolver.prototype.resolve = function (did) {
        var didContract = this.resolveContract(did);
        var publicKey = {};
    };
    return Resolver;
}());
...
//# sourceMappingURL=tls-did-resolver.js.map