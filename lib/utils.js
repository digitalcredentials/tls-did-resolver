...
exports.checkForOCSPUri = exports.checkOCSP = exports.verifyChain = exports.verifyChains = exports.createCaStore = exports.chainToCerts = exports.addValueAtPath = void 0;
...
function addValueAtPath(object, path, value) {
    ...
    pathArr.forEach(function (key, index) {
        if (index === pathArr.length - 1) {
            if (key.endsWith(']')) {
                var idx = parseInt(key.slice(-2, -1));
                key = key.slice(0, -3);
                if (!currentObj[key]) {
                    currentObj[key] = [];
                }
 ...
 */
function createCaStore(rootCertificates) {
    ...
    var pkis = rootCertificates.map(function (cert, idx) {
        try {
    ...
    return node_forge_1.pki.createCaStore(definedPkis);
}
 ...
 */
function verifyChains(chains, domain, caStore) {
    return __awaiter(this, void 0, void 0, function () {
        var filteredChains, verifiedChains, filteredChains_1, filteredChains_1_1, chain, e_1_1;
        var e_1, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    filteredChains_1 = __values(filteredChains), filteredChains_1_1 = filteredChains_1.next();
                    _b.label = 2;
                case 2:
                    if (!!filteredChains_1_1.done) return [3 /*break*/, 5];
                    chain = filteredChains_1_1.value;
                ...
                case 3:
                    ...
                    _b.label = 4;
                case 4:
                    filteredChains_1_1 = filteredChains_1.next();
                    return [3 /*break*/, 2];
                ...
                case 7:
                    try {
                        if (filteredChains_1_1 && !filteredChains_1_1.done && (_a = filteredChains_1.return)) _a.call(filteredChains_1);
                    }
                    finally { if (e_1) throw e_1.error; }
                    return [7 /*endfinally*/];
                case 8: return [2 /*return*/, verifiedChains];
            }
        });
    });
}
...
function checkForOCSPUri(cert) {
    ...
    var aIAValues = [];
    try {
        for (var _b = __values(aIAValue.value), _c = _b.next(); !_c.done; _c = _b.next()) {
            var value = _c.value;
