...
exports.processChains = exports.chainToCerts = exports.configureProvider = exports.addValueAtPath = exports.x509ToJwk = exports.debugCert = exports.getCertFromServer = exports.hashContract = exports.verify = exports.verifyCertificateChain = void 0;
 ...
 */
function debugCert() {
    var pemPath = '/../src/__tests__/ssl/certs/testserver.pem';
...
function processChains(chains) {
    ...
    var verifiedChains = chains.map(function (chain) {
...
function verifyChain(chain, caStore) {
    var certificateArray = chain.map(function (pem) { return node_forge_1.pki.certificateFromPem(pem); });
    return { chain: chain, valid: node_forge_1.pki.verifyCertificateChain(caStore, certificateArray) };
}
