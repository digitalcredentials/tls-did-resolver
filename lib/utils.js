...
exports.checkForOCSP = exports.checkOCSP = exports.processChains = exports.chainToCerts = exports.configureProvider = exports.addValueAtPath = exports.x509ToJwk = exports.hashContract = exports.verify = exports.verifyCertificateChain = void 0;
...
function processChains(chains, domain) {
    return __awaiter(this, void 0, void 0, function () {
        var filterdChains, unsupportedRootCertIdxs, pkis, definedPkis, caStore, verifiedChains, _i, filterdChains_1, chain, pemArray, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    filterdChains = Array.from(new Set(chains));
                    ...
                    pkis = tls_1.rootCertificates.map(function (cert, idx) {
                        try {
                    ...
                    verifiedChains = [];
                    _i = 0, filterdChains_1 = filterdChains;
                    _c.label = 1;
                case 1:
                    if (!(_i < filterdChains_1.length)) return [3 /*break*/, 4];
                    chain = filterdChains_1[_i];
                    pemArray = chainToCerts(chain);
                    _b = (_a = verifiedChains).push;
                    return [4 /*yield*/, verifyChain(pemArray, domain, caStore)];
                case 2:
                    _b.apply(_a, [_c.sent()]);
                    _c.label = 3;
                case 3:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, checkForOCSP(chain[0])];
                case 1:
                ...
                case 3:
                    valid = _a;
                    _b.label = 4;
                case 4: return [2 /*return*/, { chain: chain, valid: valid }];
            }
        });
    });
}
 ...
 */
function checkForOCSP(cert) {
    return __awaiter(this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Promise(function (resolve, reject) {
                        ocsp_1.default.getOCSPURI(cert, function (err, uri) {
                            if (!uri)
                                reject(false);
                            else {
                                resolve(true);
...
exports.checkForOCSP = checkForOCSP;
