...
var Resolver = /** @class */ (function () {
    function Resolver(provider, registryAddress) {
        ...
        this.configureRegistry(exports.REGISTRY || registryAddress);
    }
    ...
    Resolver.prototype.resolveContract = function (did) {
        return __awaiter(this, void 0, void 0, function () {
            var addresses, validContract, cert, _i, addresses_1, address, contract, verificationCert, valid, jwk;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        contract = new ethers_1.ethers.Contract(address, TLSDID_json_1.default.abi, this.provider);
                        verificationCert = this.debugCert();
                        return [4 /*yield*/, this.verifyContract(contract, did, verificationCert)];
                    case 3:
                        valid = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        cert = _a.sent();
                        return [2 /*return*/, cert.pemEncoded];
                }
            });
        });
    };
    ...
    Resolver.prototype.verifyContract = function (contract, did, cert) {
        return __awaiter(this, void 0, void 0, function () {
