...
function processContracts(domain, contracts, rootCertificates) {
    return __awaiter(this, void 0, void 0, function () {
        var caStore, validContract, validChain, validAttributes, _i, contracts_1, contract, chains, validChains, contractDomain, expiry, now, attributes, signature, hash, valid;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, utils_1.verifyChains(chains, domain, caStore)];
                case 3:
                    validChains = _a.sent();
