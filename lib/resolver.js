...
exports.getResolver = exports.CERT_REGISTRY = exports.REGISTRY = void 0;
...
exports.CERT_REGISTRY = '0xBCC29C38aeA44A3B6576bF6fed8584BE63A910ac';
/**
 * Resolves TLS DID
 *
...
function resolveContract(did, provider, registryAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var registry, domain, addresses, chains, verfiedChains, validChains, validContract, _i, addresses_1, address, contract, valid, err_1, jwk;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, getChains(domain, provider)];
                case 2:
                    chains = _a.sent();
                    if (chains.length === 0) {
                        throw new Error('No tls certificates were found.');
                    }
                    return [4 /*yield*/, utils_1.processChains(chains, domain)];
                case 3:
                    verfiedChains = _a.sent();
                    validChains = verfiedChains.filter(function (verfiedChain) { return verfiedChain.valid; });
                ...
                case 5:
                    _a.trys.push([5, 7, , 8]);
                    return [4 /*yield*/, verifyContract(contract, did, validChains[0].chain[0])];
                case 6:
                    valid = _a.sent();
                    return [3 /*break*/, 8];
                case 7:
                ...
                case 10:
                    ...
                    if (validContract) {
                        jwk = utils_1.x509ToJwk(validChains[0].chain[0]);
...
function getChains(domain, provider) {
    return __awaiter(this, void 0, void 0, function () {
        var certRegistry, chainCountBN, chainCount, chains, i, cert;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    certRegistry = new ethers_1.Contract(exports.CERT_REGISTRY, TLSDIDCertRegistry_json_1.default.abi, provider);
                    return [4 /*yield*/, certRegistry.getChainCount(domain)];
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    if (!(i < chainCount)) return [3 /*break*/, 5];
                    return [4 /*yield*/, certRegistry.getChain(domain, i)];
                case 3:
                    cert = _a.sent();
                    chains.push(cert);
                    _a.label = 4;
