...
function resolveContract(did, provider, registryAddress, rootCertificates) {
    return __awaiter(this, void 0, void 0, function () {
        var registry, domain, addresses, validContract, validChain, _i, addresses_1, address, contract, chains, validChains, valid, err_1, jwk;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, getChains(contract, provider)];
                case 3:
                    chains = _a.sent();
                    if (chains.length === 0) {
                ...
                case 10:
                    ...
                    if (validContract) {
                        jwk = utils_1.x509ToJwk(validChain[0]);
...
function getChains(contract, provider) {
    return __awaiter(this, void 0, void 0, function () {
