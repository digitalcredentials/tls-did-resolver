    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    addresses = _a.sent();
                    return [4 /*yield*/, utils_1.getCertFromServer(domain)];
                case 2:
                    cert = (_a.sent()).pemEncoded;
...
function verifyContract(contract, did, cert) {
    return __awaiter(this, void 0, void 0, function () {
        var signature, didDomain, contractDomain, attributes, attributeCountBN, attributeCount, i, attribute, path, value, expiryBN, expiry, today, hash, valid;
        return __generator(this, function (_a) {
            switch (_a.label) {
