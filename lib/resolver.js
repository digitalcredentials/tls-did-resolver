...
function resolveClaimants(rootCertificates, registry, domain, claimants) {
    return __awaiter(this, void 0, void 0, function () {
        var caStore, validAttributes, docValid, errors, _a, _b, _c, i, claimant, events, error_2, attributes, e_1_1;
        var e_1, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 5:
                    error_2 = _e.sent();
                    errors[i] = { claimant: claimant, error: error_2 };
                    return [3 /*break*/, 7];
                case 6:
                    if (events.length === 0) {
                ...
                case 11:
                    if (!docValid) {
                        throw new error_1.TLSDIDResolverError("did:tls:" + domain + " could not be validly resolved", errors);
                    }
        ...
        for (var events_1 = __values(events), events_1_1 = events_1.next(); !events_1_1.done; events_1_1 = events_1.next()) {
            ...
            switch (true) {
                case event.event == 'AttributeChanged':
                    ...
                    attributes.unshift({ path: path, value: value });
                    break;
